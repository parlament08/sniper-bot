...
• Точка входа: [Цена или "Нет" если НАБЛЮДЕНИЕ]
• Stop-Loss: [Цена или "Нет"]
• Take-Profit: [Цена или "Нет"]
• R:R: [Соотношение или "Нет"]
• Расчет позиции (Только для A+ SETUP): Риск 1% от 500 USDT (5$). Укажи требуемый объем позиции в USDT с учетом размера стопа. Формула: (5$ / разница входа и стопа) * цена входа.

🔥 ГОРЯЧИЕ ПРАВИЛА:
- Никакой гибкости: Вне Kill Zone = строгий запрет на торговлю.
- Если статус НАБЛЮДЕНИЕ, поля входа/стопа/тейка не заполняются гипотетическими цифрами!
"""
